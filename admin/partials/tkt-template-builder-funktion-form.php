...
<form class="tkt-shortcode-form">
	<?php
	$this->text_fieldset( 'function_name', 'Function Name', '', 'Function to execute with this ShortCode.' );
	$this->text_fieldset( 'args', 'Arguments', '', 'Arguments to pass to the function. Accepts format like argument_name:argument_value,another_argument:another_value' );
	?>
</form>
