...
<select class="tkt_template_select" name="tkt_template_parent">
	<?php
...
<h4>Header</h4>
<select class="tkt_template_select" name="tkt_template_header" <?php echo esc_attr( $disabled ); ?>>
	<?php
	...
	// Print the options.
	printf( '<option value="theme_header" ' . esc_attr( $theme_header ) . '>%s</option>', esc_html__( 'Use Theme Header', 'tkt-template-builder' ) );
	printf( '<option value="no_header" ' . esc_attr( $no_header ) . '>%s</option>', esc_html__( 'Use No Header', 'tkt-template-builder' ) );
	printf( '<option value="%s" ' . esc_attr( $global_header ) . '>%s</option>', esc_attr( $template_options['global_header'] ), esc_html__( 'Use Global Header', 'tkt-template-builder' ) );
	?>
</select>
<h4>Footer</h4>
<select class="tkt_template_select" name="tkt_template_footer" <?php echo esc_attr( $disabled ); ?>>
	<?php
	...
	printf( '<option value="theme_footer" ' . esc_attr( $theme_footer ) . '>%s</option>', esc_html__( 'Use Theme Footer', 'tkt-template-builder' ) );
	printf( '<option value="no_footer" ' . esc_attr( $no_footer ) . '>%s</option>', esc_html__( 'Use No Footer', 'tkt-template-builder' ) );
	printf( '<option value="%s" ' . esc_attr( $global_footer ) . '>%s</option>', esc_attr( $template_options['global_footer'] ), esc_html__( 'Use Global Footer', 'tkt-template-builder' ) );
	?>
</select>
<?php
if ( ! empty( $disabled ) ) {
...
<h4>ShortCode</h4>
<div class="tkt_template_shortcode_copy">
